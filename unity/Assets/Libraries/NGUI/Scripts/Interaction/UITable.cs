...
public class UITable : UIWidgetContainer
{
    ...
    public PivotPosition pivotPosition = PivotPosition.Left;
    ...
    protected void RepositionVariableSize (List<Transform> children)
    {
        ...
        Dictionary<int, float> columnsWidth = new Dictionary<int, float>();
        ...
        for (int i = 0, imax = children.Count; i < imax; ++i)
        {
            ...
            if(pivotPosition == PivotPosition.Center)pos.x -= columnsWidth[y];
            else if(pivotPosition == PivotPosition.Right)pos.x -= columnsWidth[y]*2;
